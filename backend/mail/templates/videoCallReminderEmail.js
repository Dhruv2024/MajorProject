exports.videoCallReminderEmail = (
  courseName,
  sectionName,
  videoCallTitle,
  meetStartTime,
  ...
  return `<!DOCTYPE html>
      ...
      <head>
          <meta charset="UTF-8">
          <title>Video Call Reminder - ${videoCallTitle}</title>
          <style>
              body {
      ...
      <body>
          <div class="container">
              ...
              <div class="body">
                  <p>Dear ${name},</p>
                  <p>This is a friendly reminder that your video call for the course <span class="highlight">"${capitalizeWords(
                    courseName
